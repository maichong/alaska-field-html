...
var HtmlFieldView = function (_React$Component) {
  ...
  _createClass(HtmlFieldView, [{
    ...
    value: function render() {
      ...
      var fullWidth = field.fullWidth;

      this.init();

      var helpElement = field.help ? _react2.default.createElement(
        'p',
      ...
      if (fullWidth) {
        ...
        var labelElement = field.label && !field.nolabel ? _react2.default.createElement(
          'label',
